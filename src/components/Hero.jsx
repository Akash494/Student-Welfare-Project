...
const Hero = () => {
  ...
  return (
    <div className="text-center bg-white text-gray-800 py-24 px-6">
      ...
      >
        <span className="capitalize text-[50px]">Empower Tomorrow's Leaders</span>
        <br />
        <span className="uppercase text-green-600 text-[28px]">Support Student Success Today!</span>
      </h1>
